...
export const PulseBeams = ({
  ...
  return (
    <div
      className={cn(
        "w-full h-[600px] relative flex items-center justify-center antialiased overflow-hidden",
        className
      )}
    >
      {background}
      ...
      {beams.map((beam: any, index: any) => (
        <React.Fragment key={index}>
          ...
          <path
            ...
            strokeLinecap="round"
          />
          {beam.connectionPoints?.map((point: any, pointIndex: any) => (
            <circle
